  ...
  return (
    <div className="container mx-auto px-4">
      <div className='grid gap-4 md:grid-cols-12  min-h-screen md:grid-rows-[48px_minmax(300px,_1fr)]'>
        <div className='rounded-md h-fit border bg-slate-800 border-slate-900 hidden md:block md:row-span-2 md:col-span-3'>
          <div>
            ...
            <div className="px-4">
              <ul className="mb-4">
                <li
                  className="flex items-center text-gray-100 py-2 mb-1 rounded-md cursor-pointer ease-linear duration-200">
        ...
        <div className=' md:col-span-9 md:flex items-center'>
